...
<div class="right">
        ...
        <div class="providerAdd">
            <form id="userForm" name="userForm" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath }/jsp/adduser.do">
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" value="13333333333">
					<font color="red"></font>
                </div>
                <div>
                    <label for="address">用户地址：</label>
                   <input name="address" id="address"  value="aa">
                </div>
                <div>
                    <label >用户角色：</label>
                    <!-- 列出所有的角色分类 -->
